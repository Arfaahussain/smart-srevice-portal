...
function Dashboard() {
    ...
    const load = async ()=>{
        const token = localStorage.getItem("token") || "";
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$services$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get("/requests", {
            headers: {
                authorization: token
            }
        });
...
_s(Dashboard, "sNdr84p4QTx+7nIQziMurSSoAKY=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__81edb524._.js.map